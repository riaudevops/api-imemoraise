...
import { getInfoMahasiswaByEmail, getInfoSetoranMahasiswaByNIM, getAllSetoranMahasiswaByNIM } from "../controllers/mahasiswa.controllers";
...
router.get("/mahasiswa/setoran/:nim", accessTokenValidation, authorizeRoles("mahasiswa", "dosen-pa"), getAllSetoranMahasiswaByNIM);
